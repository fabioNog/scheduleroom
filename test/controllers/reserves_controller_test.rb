...
class ReservesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserf" do
    assert_difference("Reserve.count") do
      post reserves_url, params: { reserf: { name: @reserf.name, start_date: @reserf.start_date, termination_date: @reserf.termination_date } }
    end
  ...
  test "should update reserf" do
    patch reserf_url(@reserf), params: { reserf: { name: @reserf.name, start_date: @reserf.start_date, termination_date: @reserf.termination_date } }
